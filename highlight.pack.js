...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("java",(()=>{"use strict"
...
n.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],n}})());hljs.registerLanguage("vbscript",(()=>{"use strict";function e(e){
...
relevance:0}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("bnf",(()=>{"use strict";return e=>({
...
}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
